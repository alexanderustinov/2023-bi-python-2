...
with Session(engine) as s:
    ...
    print("Countries with a value of percent of students who could not read less than 30:")
    ...
    for i in s.scalars(search_2):
        print(f"In Morocco percent of students who could not read is {i.percent}.")
