...
try:
    ...
    my_question = {"Question" : "Что делали?", "Answer" : my_ans}
    ...
    with open('Not_a_secret.txt', 'w') as f:
        f.write('Необходимо создать файл формата .py с названием "answer", в котором будет храниться переменная "my_ans = "your answer" "')
finally:
