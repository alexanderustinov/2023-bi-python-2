...
try:
    from answer import my_answer
    my_question = {"Question" : "Когда?", "Answer" : my_answer}
    ...
    with open('Not_a_secret.txt', 'w') as f:
        f.write(
            'Необходимо создать файл формата .py с названием "answer", в котором будет храниться переменная "my_answer = "your answer" "')
finally:
