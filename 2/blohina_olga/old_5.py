import webbrowser
print('Введите название языка программирования:')
s = input()
...
class Proc(Lang):
    ...
    def new_inf(self):
        ...
        webbrowser.open('https://spravochnick.ru/programmirovanie/yazyki_programmirovaniya/klassifikaciya_yazykov_programmirovaniya/')
class Nproc(Lang):
    def __init__(self):
        print(end='\r')
    def dec(self):
